<?php
    ...
    if(isset($_POST['update_user'])){
        ...
        $update_query = "UPDATE `internet_user` SET name = '$update_name', ip_add = '$update_ip', ip_pass = '$update_ip_pass', speed = '$update_speed', phone = '$update_phone', address = '$update_address' WHERE phone = '$user_phone'";
